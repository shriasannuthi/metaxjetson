...
private:
    // Tensor arena for model inference; generous headroom above model JSON defaults.
    static constexpr size_t TENSOR_ARENA_SIZE = 128 * 1024;

    // Variable arena for streaming state ops and GreedyMemoryPlanner allocations.
    static constexpr size_t VARIABLE_ARENA_SIZE = 32 * 1024;
