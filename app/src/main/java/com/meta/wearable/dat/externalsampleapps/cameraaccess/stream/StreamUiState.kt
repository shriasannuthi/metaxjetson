...
data class StreamUiState(
    ...
    val isDocumentCandidateVisible: Boolean = false,
    val isDocumentStable: Boolean = false,
    val documentDetectionScore: Float = 0f,
    val documentDetectionStatus: String? = null,
